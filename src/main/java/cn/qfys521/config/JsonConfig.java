...
public class JsonConfig<T> extends Config<T> {
    ...
    /**
     * The file path where the JSON data will be stored or loaded.
     */
    private File file;

    /**
     * Creates a new JsonConfig instance with the provided data object and file name. Enables
     * {@link SerializationFeature#INDENT_OUTPUT} for human-readable JSON output.
     *
     * @param t        The data object to be serialized or deserialized.
     * @param fileName The name of the file to store or load the JSON data.
     */
    public JsonConfig(T t, String fileName) {
    ...
    /**
     * Saves the data object `t` to the configured file path in JSON format. Throws an IOException if any errors occur
    ...
    /**
     * Converts the data object `t` to a JSON string. Throws an IOException if any errors occur during serialization.
     *
     * @return The JSON string representation of the data object `t`.
     */
    @SneakyThrows
